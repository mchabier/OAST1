...
public class BruteForce {
    ...
    public BruteForce(List<Zapotrzebowanie> listaZapotrzebowan_, List<Lacze> listaLaczy_) {
    ...
    public void wypiszRozwiazania() {
        ...
        for (Rozwiazanie rozwiazanie : rozwiazania) {
            if (rozwiazanie.ocenRozwiazanie(listaZapotrzebowan, listaLaczy)) {
